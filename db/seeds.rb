...
aparelho_genital_feminino = Content.create!(order: 4, name: 'aperlho genital feminino', description: 'Aparelho genital feminino ou aparelho reprodutor feminino é o órgão característico do sexo feminino que é responsável tanto pela eliminação de urina quanto pela reprodução.', subject: anatomia1)
